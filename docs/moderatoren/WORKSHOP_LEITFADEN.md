...
Bereite ein Test-PDF vor (2-3 Seiten). Stelle das Teilnehmer-Skript bereit (ausgedruckt oder als Link zu `docs/teilnehmer/TEILNEHMER_SKRIPT.md`). Prüfe Beamer/Laptop-Verbindung für eventuelle Präsentationen.
...
Weise die Teilnehmer an, dem Teilnehmer-Skript zu folgen (`docs/teilnehmer/TEILNEHMER_SKRIPT.md`), beginnend mit Teil 2.
